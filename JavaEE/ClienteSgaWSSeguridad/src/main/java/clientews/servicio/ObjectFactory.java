...
public class ObjectFactory {
    ...
    private final static QName _ListarPersonas_QNAME = new QName("http://services.sga.gm.com.co/", "listarPersonas");
    private final static QName _ListarPersonasResponse_QNAME = new QName("http://services.sga.gm.com.co/", "listarPersonasResponse");
    private final static QName _Persona_QNAME = new QName("http://services.sga.gm.com.co/", "persona");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.sga.gm.com.co/", name = "listarPersonas")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.sga.gm.com.co/", name = "listarPersonasResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.sga.gm.com.co/", name = "persona")

 ...
 * 
 */
@WebServiceClient(name = "PersonaServiceImplService", targetNamespace = "http://services.sga.gm.com.co/", wsdlLocation = "http://localhost:8080/PersonaServiceImplService/PersonaServiceImpl?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PERSONASERVICEIMPLSERVICE_QNAME = new QName("http://services.sga.gm.com.co/", "PersonaServiceImplService");
    ...
    public PersonaServiceWS getPersonaServiceImplPort() {
        return super.getPort(new QName("http://services.sga.gm.com.co/", "PersonaServiceImplPort"), PersonaServiceWS.class);
    }
    ...
    public PersonaServiceWS getPersonaServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.sga.gm.com.co/", "PersonaServiceImplPort"), PersonaServiceWS.class, features);
    }
